public class Palindrome
{
	...
	{
		// Wasn't specified how to handle these cases, but we'll consider them non-palindromes here
	...
	public static void testPalindrome(String input)
	{
		...
		System.out.println(isPalindrome(input) ? "a palindrome." : "NOT a palindrome");
	}
}